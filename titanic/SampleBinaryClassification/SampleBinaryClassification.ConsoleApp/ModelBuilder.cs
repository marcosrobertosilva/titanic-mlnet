...
namespace SampleBinaryClassification.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\evsro\Documents\source\repos\titanic-mlnet\titanic\train.csv";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options() { NumberOfLeaves = 16, MinimumExampleCountPerLeaf = 1, NumberOfTrees = 500, LearningRate = 0.07864782f, Shrinkage = 0.07738367f, LabelColumnName = "Survived", FeatureColumnName = "Features" });
